...
export default function Register () {
    ...
    const [paysVAT, setPaysVAT] = useState('')
    ...
    return (
        ...
        <form className={'registerForm'}>
            ...
            <input type="password"  id="password" onChange={e => setPasswordHash(e.target.value)}/>
            ...
            <div className={'radioRegister'} onChange={e => setPaysVAT(e.target.value)}>
                <p>VAT payer:</p>
                <input type="radio" id="yesVat" name="vatPayer" value={true} />
                <label htmlFor="yesVat">Yes</label>
                <input type="radio" id="noVat" name="vatPayer" value={false}/>
            ...
            <input type="text" placeholder="Bank" id="bank" onChange={e => setBank(e.target.value)}/>
            ...
            <input type="text" placeholder="county" id="county" onChange={e => setCounty(e.target.value)}/>

            <label htmlFor="telephoneNumber">Telephone Number</label>
            <input type="numeric" placeholder="Telephone Number" id="telephoneNumber" onChange={e => setPhone(e.target.value)}/>


            <Dropdown options={options} onChange={e => {setType(e.value)}} value={defaultValue} placeholder="Select an option" />
